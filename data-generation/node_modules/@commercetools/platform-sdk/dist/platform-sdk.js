...
;(exports.ApiRoot = Hr),
  (exports.createApiBuilderFromCtpClient = function(e, r) {
    return new Hr({ executeRequest: e.execute, baseUri: r })
  }),
  (exports.createExecutorFromMiddlewares = function(e, r) {
    return r && 0 != r.length ? Qr(r.reduce(Jr), e) : e
  })
