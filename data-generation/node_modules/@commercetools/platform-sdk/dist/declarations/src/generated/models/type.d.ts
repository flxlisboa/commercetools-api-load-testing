...
export declare type ResourceTypeId = 'address' | 'asset' | 'cart-discount' | 'category' | 'channel' | 'custom-line-item' | 'customer' | 'customer-group' | 'discount-code' | 'inventory-entry' | 'line-item' | 'order' | 'order-edit' | 'payment' | 'payment-interface-interaction' | 'product-price' | 'review' | 'shipping-method' | 'shopping-list' | 'shopping-list-text-line-item' | 'store';
