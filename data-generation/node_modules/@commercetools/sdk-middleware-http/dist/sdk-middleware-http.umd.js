            ...
            function createHttpMiddleware(_ref2) {
              ...
              return function (next) {
                return function (request, response) {
                  ...
                  var body = requestHeader['Content-Type'] === 'application/json' && typeof request.body !== 'string' ? // NOTE: `stringify` of `null` gives the String('null')
                  JSON.stringify(request.body || undefined) : request.body;
